...
@Autonomous(name="Robot: blue_frontstage_auto_drive", group="blue")
//@Disabled
public class blue_frontstage_auto_drive extends LinearOpMode {
...
*/
        turnToHeading( TURN_SPEED, 0.0);               // Turn  CW to -90 Degrees
        holdHeading( TURN_SPEED, 0.0, 0.5);   // Hold -90 Deg heading for a 1/2 second
        driveStrafe(STRAFE_SPEED,-90.0, 0.0);    // Strafe in Reverse 48" (should return to approx. staring position)
